...
function isFatalTriggerError(error: unknown): boolean {
	...
	return [
		'Connection mode SSH is planned',
		'Host is required',
...
export class DockerTrigger implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					'Phase 4 adds a dedicated Docker Trigger that replays missed events from the stored cursor and keeps a live event stream active with reconnect backoff.',
