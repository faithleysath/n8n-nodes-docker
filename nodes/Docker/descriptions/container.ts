...
export const containerOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			{ name: 'List Files', value: 'listFiles', action: 'List files in a container' },
			{ name: 'Logs', value: 'logs', action: 'Fetch container logs' },
			{
				name: 'Read Text File',
				value: 'readTextFile',
				action: 'Read a text file from a container',
			},
			{ name: 'Remove', value: 'remove', action: 'Remove a container' },
			{
				name: 'Replace Exact Text',
				value: 'replaceExactText',
				action: 'Replace exact text in a container file',
			},
			{ name: 'Restart', value: 'restart', action: 'Restart a container' },
			{ name: 'Search Text', value: 'searchText', action: 'Search text in a container' },
			...
			{ name: 'Wait', value: 'wait', action: 'Wait for a container state' },
			{
				...
				value: 'writeTextFile',
				action: 'Write a text file to a container',
			},
		],
	},
];
...
export const containerFields: INodeProperties[] = [
	...
	},
	{
		...
		description:
			'Absolute path inside the container. Relative file paths resolve from here. Linux containers only.',
		displayOptions: containerOperationDisplay([
			'listFiles',
			'readTextFile',
			'replaceExactText',
			'searchText',
	...
	},
	{
		...
		default: '',
		required: true,
		placeholder: 'app/config.json or /workspace/app/config.json',
		description: 'Absolute path, or a path relative to Working Path',
		displayOptions: containerOperationDisplay([
			'readTextFile',
			'replaceExactText',
			'writeTextFile',
	...
	},
	{
		...
		type: 'string',
		default: '',
		description: 'Only return content starting from this 1-based line number',
		displayOptions: containerOperationDisplay(['readTextFile']),
	},
	{
		...
		type: 'string',
		default: '',
		description: 'Only return content through this 1-based line number',
		displayOptions: containerOperationDisplay(['readTextFile']),
	},
	{
		displayName: 'Glob',
		...
		default: '',
		placeholder: '*.log',
		description: 'Optional shell-style pattern to filter candidate files',
		displayOptions: containerOperationDisplay(['listFiles', 'searchText']),
	},
	{
		...
		displayOptions: containerOperationDisplay(['listFiles']),
	},
	{
		...
		default: 4,
		description: 'How many directory levels to traverse below Working Path',
		displayOptions: containerOperationDisplay(['listFiles']),
	},
	{
		displayName: 'Return All',
		name: 'listFilesReturnAll',
		type: 'boolean',
		default: true,
		description: 'Whether to return every discovered entry or only up to a given limit',
		displayOptions: containerOperationDisplay(['listFiles']),
	},
	{
		displayName: 'Limit',
	...
	},
	{
		...
		required: true,
		placeholder: 'TODO',
		description: 'Literal text to search for inside files under Working Path',
		displayOptions: containerOperationDisplay(['searchText']),
	},
	{
	...
	{
		displayName: 'Return All',
		name: 'searchTextReturnAll',
		type: 'boolean',
		default: true,
		description: 'Whether to return every text match or only up to a given limit',
		displayOptions: containerOperationDisplay(['searchText']),
	},
	{
		displayName: 'Limit',
		name: 'searchTextLimit',
		type: 'number',
		typeOptions: {
			minValue: 1,
		},
	...
	},
	{
		...
		default: '',
		required: true,
		description: 'UTF-8 text to write into the target file',
		displayOptions: containerOperationDisplay(['writeTextFile']),
	},
	{
		...
		default: true,
		description:
			'Whether to run a fixed /bin/sh mkdir step before uploading the file. Linux containers only.',
		displayOptions: containerOperationDisplay(['writeTextFile']),
	},
	{
		...
		default: '',
		required: true,
		description: 'Exact UTF-8 text that must appear exactly once in the target file',
		displayOptions: containerOperationDisplay(['replaceExactText']),
	},
	{
		...
		default: '',
		description: 'Replacement text to write when Old Text matches exactly once',
		displayOptions: containerOperationDisplay(['replaceExactText']),
	},
	{
